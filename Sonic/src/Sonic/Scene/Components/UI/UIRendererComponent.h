...
namespace Sonic {
	...
	public:
		...
		void SetBorderWeight(int borderWeight) { properties.borderWeight = borderWeight; *dirty = true; }
		void SetEdgeRadius(int edgeRadius) { properties.edgeRadius = edgeRadius; *dirty = true; }
